...
public class userService {
    ...
    public userService(String usernames, String passwords)
    {
        ...
        String[][] data = 
        { 
            {"Reehan Putra", "047", "superAdmin"},
            {"Andika Auli", "113", "superduperAdmin"} 
        };
        // dibuat data histories berisi buku yang email user, buku yang dipinjam, dan tanggal peminjaman
        String[][] histories = 
        {
            {"Reehan Putra", "Sastra", "Matematika", "29-04-2020"},
            {"Andika Auli", "Fisika", "Seni Budaya", "27-04-2020"} 
        };
        this.data = data;
    ...
    public void login()
    {
        ...
        if(status == true)
        {
            ...
            System.out.println("\nWelcome Slurr " + roles);
            System.out.println("Logged it as username " + username);
            ...
            System.out.println("Deadline Pengembalian : " + tanggal);
            System.out.println("Harap segera mengembalikan bukunya ya slurrr");
        }
        else
        {
